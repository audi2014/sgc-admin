...
export const MSG_MODE_STATIC = "MSG_MODE_STATIC";
export const MSG_MODE_MODAL = "MSG_MODE_MODAL";
export const MSG_MODE_DIALOG = "MSG_MODE_DIALOG";
...
export var MAX_IMG_SIZE_MB = 5;
export var MAX_PDF_SIZE_MB = 150;
